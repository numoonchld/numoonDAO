...
const App = () => {
	...
	const vote = useVote('0xe5A824b52F23Ee9C752D73316A61305719d80a67');
	...
	const mintNFT = async () => {
		try {
			...
			console.log(
				`Membership NFT minted! LinK: https://testnets.opensea.io/assets/${editionDrop.getAddress()}/0`
			);
			setHasClaimedNFT(true);
		} catch (error) {
			setHasClaimedNFT(false);
		...
		<>
			<div className="landing logoHolder">
				...
				<button disabled={isClaiming} onClick={mintNFT}>
					{isClaiming ? <div className="mintingSpinner" /> : `Mint FREE NFT!`}
				</button>
			</div>
		</>
	);
